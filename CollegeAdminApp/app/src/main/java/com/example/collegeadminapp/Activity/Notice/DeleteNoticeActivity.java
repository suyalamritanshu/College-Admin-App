...
import com.example.collegeadminapp.Adapters.NoticeAdapter;
...
public class DeleteNoticeActivity extends AppCompatActivity {
    private RecyclerView deleteNotiverv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteNotiverv = findViewById(R.id.deleteNotiverv);
        progressBar = findViewById(R.id.progressBar);

        reference = FirebaseDatabase.getInstance().getReference().child("Notice");

        deleteNotiverv.setLayoutManager(new LinearLayoutManager(this));
        deleteNotiverv.setHasFixedSize(true);
    ...
    private void getNotice() {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                deleteNotiverv.setAdapter(adapter);
            }
